...
(async function () {
	...
	model = await tf.loadModel('http://skin.test.ehealthai.eu/model_kaggle_version12/model.json');
	$("#selected-image").attr("src", "http://skin.test.ehealthai.eu/assets/samplepic.jpg")
